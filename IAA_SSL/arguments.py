...
def get_args():
    ...
    root_config_path = './configs/'
    # os.path.join(root_config_path, args.config_file)
    with open(os.path.join(root_config_path, args.config_file), 'r') as f:
    ...
    args.log_dir = os.path.join(args.log_dir, 'completed_'+args.name)

    os.makedirs(args.log_dir, exist_ok=True)
    print(f'creating file {args.log_dir}')
    os.makedirs(args.ckpt_dir, exist_ok=True)

    shutil.copy2(os.path.join(root_config_path, args.config_file), args.log_dir)
